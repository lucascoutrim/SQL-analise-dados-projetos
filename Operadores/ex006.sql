...
select 
	...
	birth_date, -- seleciona a data de nascimento
	(current_date - birth_date) / 365 as "idade do cliente" -- calcula a idade aproximada do cliente em anos
from sales.customers; -- define a tabela de onde os dados serão puxados (schema sales, tabela customers)
...
select 
	first_name || ' ' || last_name as nome_completo -- concatena nome e sobrenome formando o nome completo
from sales.customers; -- define a tabela de onde os dados serão puxados (schema sales, tabela customers)
